...
def create_detections(objects_in_single_frame, frame_idx, min_height=0):
    ...
    """
    detection_list = []
    for object in objects_in_single_frame:
        bbox = object["Box"]
        confidence = object["Confidence"]
        label = object["Class"]
        detection_list.append(Detection(bbox, confidence, label))
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="/media/mikolaj/Maxtor1/Datasets/Change_to_upload/MOT some from higher ground/MOT17/train/MOT17-04-DPM",
    )
    parser.add_argument(
        "--detection_file",
        help="Path to custom detections.",
        default="/home/mikolaj/Programs/deep_sort/MOT16-04.npy",
    )
    parser.add_argument(
        "--output_file",
