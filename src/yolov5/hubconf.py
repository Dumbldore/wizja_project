...
def yolov5s6(
    ...
    return _create(
        "yolov5s6", pretrained, channels, classes, autoshape, verbose, device
    )
...
def yolov5m6(
    ...
    return _create(
        "yolov5m6", pretrained, channels, classes, autoshape, verbose, device
    )
...
def yolov5l6(
    ...
    return _create(
        "yolov5l6", pretrained, channels, classes, autoshape, verbose, device
    )
...
def yolov5x6(
    ...
    return _create(
        "yolov5x6", pretrained, channels, classes, autoshape, verbose, device
    )
